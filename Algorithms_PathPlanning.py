...
class Algorithms_PlathPlanning():
    ...
    def Q_Learning_Length_Only_AGV(self,
        ...
        last_position_posX, last_position_posY, *order = self.AGVs[_each_AGV_ID].GetLastScheduledPos()
        last_position = (last_position_posX, last_position_posY)
        ...
        for order_ID, shelf_IDs, depot_ID in _each_AGV_schedule:
            for each_shelf_IDs in shelf_IDs:
                ...
                if path_key in self.reserve_paths:
                    ...
                    each_path_length = self._new_paths[path_key][0]
                    
                each_AGV_path_length += each_path_length

                (each_shelf_pos_X, each_shelf_pos_Y) = each_shelf_pos
                each_AGV_order_list.append([time_step, each_shelf_pos_X, each_shelf_pos_Y, each_path_length, each_path_length])
                ...
                each_AGV_order_list.append([time_step, each_depot_pos_X, each_depot_pos_Y, each_path_length, 0])
                time_step += each_path_length
                ...
                (each_shelf_pos_X, each_shelf_pos_Y) = each_shelf_pos
                each_AGV_order_list.append([time_step, each_shelf_pos_X, each_shelf_pos_Y, each_path_length, 0])
                time_step += each_path_length
